...
(() => {
  ...
  /* =====================================================================
     ...
     ===================================================================== */
  const AUTH_KEY = "rp_admin_login_v1";
    ...
    return `<main class="rp-login-wrap">
      <section class="rp-login-card">
        ...
        <form id="rp-login-form" class="rp-login-form" autocomplete="off">
          ...
          <input id="rp-user" type="text" placeholder="Usuario" autocomplete="off" required>

          <label for="rp-pass">Contraseña</label>
          <input id="rp-pass" type="password" placeholder="Contraseña" autocomplete="new-password" required>
