...
(() => {
  ...
  /* =====================================================================
     SEGURIDAD DE ENTRADA SIMPLE
     ===================================================================== */
  const ADMIN_USER = "admi";
  const ADMIN_PASS = "roody1234";
  const LOGIN_KEY = "rp_admin_login_simple_v1";
    ...
    return `<main class="rp-login-wrap">
      <section class="rp-login-card">
        ...
        <form id="rp-login-form" class="rp-login-form" autocomplete="off">
          ...
          <p class="rp-login-note">Acceso privado del administrador.</p>
        </form>
      </section>
    </main>`;
  }
